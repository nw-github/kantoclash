...
const createGeneration = (): Generation => {
  const patches: Partial<GenPatches> = {
    ...
    tryDamage,
    itemTypeBoost: {
      softsand: {type: "ground", percent: 20},
      hardstone: {type: "rock", percent: 20},
      metalcoat: {type: "steel", percent: 20},
      pinkbow: {type: "normal", percent: 20},
      blackbelt: {type: "fight", percent: 20},
      sharpbeak: {type: "flying", percent: 20},
      poisonbarb: {type: "poison", percent: 20},
      silverpowder: {type: "bug", percent: 20},
      spelltag: {type: "ghost", percent: 20},
      polkadotbow: {type: "normal", percent: 20},
      charcoal: {type: "fire", percent: 20},
      mysticwater: {type: "water", percent: 20},
      miracleseed: {type: "grass", percent: 20},
      magnet: {type: "electric", percent: 20},
      twistedspoon: {type: "psychic", percent: 20},
      nevermeltice: {type: "ice", percent: 20},
      dragonfang: {type: "dragon", percent: 20},
      blackglasses: {type: "dark", percent: 20},
      silkscarf: {type: "normal", percent: 20},
      seaincense: {type: "water", percent: 20},
    },
