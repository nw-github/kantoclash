...
export const formatInfo: Record<FormatId, FormatInfo> = {
  g5_standard: {
    ...
    desc: "A standard battle allowing all BW and B2W2 Pokémon.",
    needsTeam: true,
  ...
  g5_doubles: {
    name: "[BW2] Doubles",
    icon: "akar-icons:sword",
    desc: "A standard double battle allowing all BW and B2W2 Pokémon.",
    needsTeam: true,
    chooseLead: "teamPreview",
    mods: {endlessBattle: true},
    generation: 5,
  ...
  g5_metronome: {
    name: "[BW2] Random Metronome Battle",
    icon: "mdi:metronome",
