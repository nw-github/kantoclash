...
export const infoMessage: Record<InfoReason, string> = {
  ...
  become_confused: "{} became confused!",
  fatigue_confuse: "{} became confused due to fatigue!",
  fatigue_confuse_max: "{} became confused due to fatigue!",
  ...
  healingwish: "The healing wish came true for {}!",
};
